...
// const contents = fs.readFile('./IconExamples.tsx', (err, data) => {
//   if (err) throw err;
//   console.log(data);
//   fs.copyFileSync(data, './file.tsx')
// });
...
function processFiles(src, dest) {
  ...
  console.log('iconContents', iconContents)
  ...
  files.forEach(function (file, index) {
    ...
    if (fs.lstatSync(srcFile).isDirectory()) {
      ...
      var jsxCode = resizable
        ? svgr.default.sync(iconContent, svgrOpts, { filePath: file })
        : svgr.default.sync(iconContent, svgrOptsSizedIcons, {
            filePath: file,
          });

      console.log(typeof jsxCode);
      var jsCode = `
