...
function processFiles(src, dest) {
  ...
  console.log('CONTENTS', iconContents)
...
var rnCode = jsxCode.replace(rnRegex, function(r) { var t = new RegExp('[a-zA-Z]'); console.log(r.replace(t, r => r.toUpperCase())); return r.replace(t, r => r.toUpperCase()) });
      var jsCode = 
`
...
//   );
// };
// export default Add28RegularIcon;

// Bundle


function convertRectNativeSvg() {
const rnRegex = new RegExp('[<|\/>](svg|path|rect|g)', 'g')
}